   ...
   // var scoreGreater = false
    console.log(user.uid)
        ...
        if (user){
             ...
             .then(function (doc) 
             {console.log(score)
                 //console.log(doc.data().spaceinvadersscore)
                 
                 
                    if(doc.data().spaceinvadersscore === undefined || doc.data().spaceinvadersscore < score)
                    {
                    firestore.collection('users').doc(user.uid).update({
                        spaceinvadersscore : score
			...
			firestore.collection('highscores').doc('spaceinvaders')
			.get()
			.then(function (doc) 
			{console.log(score)
			   ...
			   console.log(doc.data())
				   ...
				   if(doc.data() === undefined) {
					   ...
					   if(doc.data().spaceinvadersscore === undefined || doc.data().spaceinvadersscore < score)
					   {
					   firestore.collection('highscores').doc('spaceinvaders').update({
						   spaceinvadersscore : score
					   }) 
					   }
				   else {
