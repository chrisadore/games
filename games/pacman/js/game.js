        ...
        if (user){
             ...
             {console.log(score)
                 //console.log(doc.data().spaceinvadersscore)
                    ...
                    if(doc.data().pacmanscore === undefined || doc.data().pacmanscore < score)
                    {
			...
			firestore.collection('highscores').doc('pacman')
			.get()
			.then(function (doc) 
			{console.log(score)
			   ...
			   console.log(doc.data())
				   ...
				   if(doc.data() === undefined) {
					   ...
					   if(doc.data().pacmanscore === undefined || doc.data().pacmanscore < score)
					   {
					   firestore.collection('highscores').doc('pacman').update({
						   pacmanscore : score
					   }) 
					   }
				   else {
